const categories = [
    ...
    },
    {
        ...
        generate: (forum, user, manager) => {
            ...
            [/B][B][SIZE=3]שלמה מנהל תותח שעושה את התפקיד כראוי תמיד נותן מעצמו למען הפורום משקיע 
            מחזיק את הפעילות שלו מוציא סטטיסטיקה פשוט מדהימה מנהל אחראי ובוגר 
            מבצע את כול המטלות פשוט אלוף המשך בדרך הזו וכפי שאמרתי תגיע רחוק [/SIZE][/B][/TD]
            [/TR]
            [TR]
